<template>
  <div class="cakeAnimation">
    ...
    <div class="text">
      <h1 class="colorFont">happy birthday!</h1>
      <p class="colorFont" style="margin-top:10px;">{{yourName}}</p>
    </div>
...
@-webkit-keyframes fuego {
  ...
  100% {
    ...
    -webkit-box-shadow: 0 0 0.8rem 0.2rem rgba(248, 233, 209, 0.2);
    box-shadow: 0 0 0.8rem 0.2rem rgba(248, 233, 209, 0.2);
  ...
  50% {
    ...
    -webkit-box-shadow: 0 0 0.8rem 0.4rem rgba(248, 233, 209, 0.2);
    box-shadow: 0 0 0.8rem 0.4rem rgba(248, 233, 209, 0.2);
    -webkit-transform: translateY(-0.4rem) scale(0);
